...
const Dashboard = () => {
  // Mock data for the tools available in CodeLens
  const tools = [
    {
      id: 'know-codebase',
  ...
  return (
    <div className="min-h-screen bg-[#0A0D14] text-gray-300 font-sans p-8 md:p-12">
      ...
      <header className="flex justify-between items-center mb-16 max-w-6xl mx-auto">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-bold text-white tracking-wide">Code<span className="text-blue-500">Lens</span></span>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 cursor-pointer bg-gray-900/50 border border-gray-800 px-3 py-1.5 rounded-full hover:bg-gray-800 transition-colors">
            <div className="w-6 h-6 rounded-full bg-gradient-to-tr from-purple-500 to-blue-500 flex items-center justify-center text-white text-[10px] font-bold">FS</div>

...
const GithubConnectForm = ({ onSubmit, isLoading, loadingText }) => {
  ...
  return (
    <div className="w-full max-w-xl mx-auto bg-[#11151D] border border-gray-800/60 rounded-2xl shadow-2xl overflow-hidden relative">
      ...
      <div className="p-8">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-white tracking-wide">Connect Repository</h2>
        ...
        {/* Terminal Loading Output (Visible only when loading) */}
        {isLoading && (
